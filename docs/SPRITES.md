...
All item textures the mod needs. **7 vanilla materials** each: `wooden, stone, copper, iron, golden, diamond, netherite`, plus the optional metal `steel`.
(Copper and steel currently reuse the iron art as placeholders and need their own pass.)
...
**Total melee/component sprite files: 243** (plus the 85 ranged sprites above = **328**). Steel adds 30 on top of the 7-material rows below.
